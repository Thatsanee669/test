...
% % % This one will extract data from imagery pair between 1 and other
% images until the last one
% % % Thatsanee Sanouban % % %

% % set working folder to the folder that contains the data between July
% 2019 to March 2020
...
outputfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Tasman_Jul_2019 - March 2020 UTM\Velocity\Compared with the first scence';
