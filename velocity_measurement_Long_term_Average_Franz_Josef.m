...
%%% This Part will look at long term average of Franz Glacier %%%
%%% The author will use the first scene taken on 2020-02-24 and the second  %%% 
%%% scene taken on 2020-04-10 in which its time interval is 46 days %%%

% set working folder to the folder that contains the data 
  
workfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Spatial Variation\Franz Josef\Imagery\First and Last images';
outputfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Spatial Variation\Franz Josef\Velocity\Long-term mean';
...
for i = 1:(length(files)-1) % we will loop from 1 to the second last number of imager (Pairing 1 and 1 + i)
   ...
   R = georefcells([-43.504661 -43.468375],[170.18633 170.235704], size(Vn), ...
