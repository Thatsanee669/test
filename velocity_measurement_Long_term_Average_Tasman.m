...
%%% This Part will look at long term average of Tasman Glacier %%%
%%% The author will use the first scene taken on 2018-12-23 and the second  %%% 
%%% scene taken on 2020-10-21 in which its time interval is 1 year %%%

% set working folder to the folder that contains the data 
  
workfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Spatial Variation\Imagery\First and Last images';
outputfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Spatial Variation\Velocity\Average velocity';
