...
% % % This one will extract data from imagery pair between Scenes eg. 1 with 2/ two
% with 3/ 3 with 4 and 4 with 5 and so on. 
% % % Thatsanee Sanouban % % %
% % % This is to de temporal resolution from at least 2 days to at least 5 days % % %
% % % Venus Satellite Imagery % % % we use the original 
...
workfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\Study Areas\Tasman\Tif_UTM - Deresolution\Detemporal-Resolution\5 days';
outputfolder='C:\Users\Advice\OneDrive - Victoria University of Wellington - STUDENT\GISC 511\ImGraft\Tasman_Deresolution_Velocity\5 days';
